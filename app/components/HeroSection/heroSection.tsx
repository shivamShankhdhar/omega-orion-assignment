...
const HeroSection = () => {
  return (
    <div className="relative flex flex-col items-center justify-between bg-[url('/assets/design-5.png')] bg-cover bg-center inset-0  z-0">
        <div className="w-full bg-black/80 z-50">
        <Navbar/>
        <div className="h-[100px]"></div>
        <div className="w-full flex flex-wrap py-3 items-center">
            <div className="flex-1 ml-[80px] mr-[50px] flex text-2xl font-bold">
                Pixel Bloom: AI website agency
            </div>
            <div className="flex gap-5 justify-center items-center px-5 text-sm">
